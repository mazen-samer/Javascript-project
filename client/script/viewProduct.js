  ...
  if (clickedProduct) {
    ...
    // </div>`;
     ...
     boxProduct.innerHTML = `
       ...
       <div class="card bg-white rounded-lg shadow-lg p-6 max-w-4xl w-full flex">
        ...
        <div class="w-[400px] pl-10">
            ...
            <h1 class="text-xl font-semibold text-gray-900">${clickedProduct.title}</h1>
            
               </div>
            <p class="text-xl font-semibold text-gray-700 mt-2"> $${clickedProduct.price}</p>
